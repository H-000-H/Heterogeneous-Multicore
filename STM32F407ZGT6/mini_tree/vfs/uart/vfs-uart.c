...
#include "driver.h"
#define UART_COUNT DTC_GEN_COUNT_STM32_UART1
...
{
    COMPAT_IGNORE_RESULT(osal_pool_init(&s_uart_pool_ctrl,s_uart_used,UART_COUNT));
}
...
DRIVER_REGISTER(uart,"stm32,uart1",uart_master_probe, uart_master_remove)