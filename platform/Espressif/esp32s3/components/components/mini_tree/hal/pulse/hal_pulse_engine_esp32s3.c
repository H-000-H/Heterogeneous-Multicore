...
static int pulse_engine_hw_init(struct pulse_engine* engine,const struct hal_pulse_ws2812_hw* hw)
{
...
static int pulse_engine_xmit(struct pulse_engine* engine,rmt_encoder_handle_t encoder,const void* data, size_t len,uint32_t timeout_ms)
{
...
int hal_pulse_ws2812_send(int engine_id, const uint8_t* data, size_t len,uint32_t timeout_ms)
{
    struct pulse_engine* engine;
