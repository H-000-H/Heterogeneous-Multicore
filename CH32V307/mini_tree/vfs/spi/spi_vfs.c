...
#if SPI_SLAVE_VFS_COUNT == 0
#define SPI_SLAVE_VFS_COUNT_EMPTY 1
#else
#define SPI_SLAVE_VFS_COUNT_EMPTY SPI_SLAVE_VFS_COUNT
#endif
...
static struct spi_slave_vfs  s_slave_pool[SPI_SLAVE_VFS_COUNT_EMPTY] COMPAT_ALIGNED(4);
static uint8_t               s_slave_used[SPI_SLAVE_VFS_COUNT_EMPTY] COMPAT_ALIGNED(4);
