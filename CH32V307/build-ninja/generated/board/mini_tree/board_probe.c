...
extern int __attribute__((weak)) board_driver_probe_uart_host_vfs_ch32(struct device* dev);

/* ===== remove 函数声明 ===== */
extern int __attribute__((weak)) board_driver_remove_gpios(struct device* dev);
extern int __attribute__((weak)) board_driver_remove_uart_host_vfs_ch32(struct device* dev);
...
static const probe_fn_t s_probe_fns[DEV_ID_COUNT] = {
    ...
    [DEV_ID_UART_0] = board_driver_probe_uart_host_vfs_ch32,
};
...
static const remove_fn_t s_remove_fns[DEV_ID_COUNT] = {
    ...
    [DEV_ID_SPI_0] = NULL,
    [DEV_ID_W25Q64_0] = NULL,
    [DEV_ID_UART_0] = board_driver_remove_uart_host_vfs_ch32,
};
